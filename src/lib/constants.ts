...
export const PAYMENT_METHODS = ["payfast"] as const;
...
export const SUPPLY_PAYMENT_METHODS = ["online", "wallet"] as const;
...
export const PAYMENT_STATUSES = ["unpaid", "pending_confirmation", "paid", "failed"] as const;
