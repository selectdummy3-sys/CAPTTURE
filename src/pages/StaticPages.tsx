...
const CONTENT: Record<string, PageContent> = {
  about: {
    ...
    body: [
      ...
      "Every store on CAPTTURE is vetted before it can sell. Orders ship directly from the maker to your door, paid securely online.",
  ...
  terms: {
    ...
    body: [
      ...
      "Payment is processed securely online at checkout. Orders are confirmed once payment is received.",
    ],
  },
  "seller-terms": {
  ...
  help: {
    ...
    body: [
      ...
      "Payments: pay securely by card or mobile at checkout. Orders are confirmed once payment is received.",
